...
### `doqment/chunker.py` — 청킹 전략
- `max_words=1500`: 청크당 단어 수. 줄이면 정밀도↑ 속도↓, 늘리면 반대
- `overlap_ratio=0.20`: 이전 청크와 20% 겹침 → 경계 문맥 보존
- Gemma3:4b 기준 1500 단어 ≈ 2000 토큰 (num_ctx=8192 내 여유 충분)
